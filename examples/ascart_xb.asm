...
*                               Clear the screen
       ...
       LI   R1,>6000          * Write a space (>20 hex plus >60 bias)
...
DISP   MOVB *R1+,R3           * Get next char
       AI   R3,>6000          * Add BASIC bias
       MOVB R3,@VDPWD         * Write a byte of the message to the VDP
       DEC  R2                * Byte counter
