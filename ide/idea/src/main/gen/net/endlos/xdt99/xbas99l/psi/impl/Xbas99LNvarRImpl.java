...
public class Xbas99LNvarRImpl extends Xbas99LNamedElementImpl implements Xbas99LNvarR {

  public Xbas99LNvarRImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitNvarR(this);
  }
