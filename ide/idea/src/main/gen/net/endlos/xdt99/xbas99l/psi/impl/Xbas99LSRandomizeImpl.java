...
public class Xbas99LSRandomizeImpl extends ASTWrapperPsiElement implements Xbas99LSRandomize {

  public Xbas99LSRandomizeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitSRandomize(this);
  }
