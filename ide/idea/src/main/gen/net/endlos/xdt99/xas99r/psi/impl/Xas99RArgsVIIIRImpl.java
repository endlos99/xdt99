...
public class Xas99RArgsVIIIRImpl extends ASTWrapperPsiElement implements Xas99RArgsVIIIR {

  public Xas99RArgsVIIIRImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xas99RVisitor visitor) {
    visitor.visitArgsVIIIR(this);
  }
