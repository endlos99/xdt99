...
public class Xga99RArgsIXImpl extends ASTWrapperPsiElement implements Xga99RArgsIX {

  public Xga99RArgsIXImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public Xga99ROpMd getOpMd() {
    return findChildByClass(Xga99ROpMd.class);
  }
