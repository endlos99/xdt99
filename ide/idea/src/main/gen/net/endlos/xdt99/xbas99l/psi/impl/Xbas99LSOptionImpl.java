...
public class Xbas99LSOptionImpl extends ASTWrapperPsiElement implements Xbas99LSOption {

  public Xbas99LSOptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitSOption(this);
  }
