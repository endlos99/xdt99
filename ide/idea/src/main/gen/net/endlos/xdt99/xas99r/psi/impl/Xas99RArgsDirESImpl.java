...
public class Xas99RArgsDirESImpl extends ASTWrapperPsiElement implements Xas99RArgsDirES {

  public Xas99RArgsDirESImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xas99RVisitor visitor) {
    visitor.visitArgsDirES(this);
  }
