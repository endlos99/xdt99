...
public class Xbas99LSvarRImpl extends Xbas99LNamedElementImpl implements Xbas99LSvarR {

  public Xbas99LSvarRImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitSvarR(this);
  }
