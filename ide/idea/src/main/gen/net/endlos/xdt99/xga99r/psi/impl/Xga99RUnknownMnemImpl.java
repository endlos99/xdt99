...
public class Xga99RUnknownMnemImpl extends ASTWrapperPsiElement implements Xga99RUnknownMnem {

  public Xga99RUnknownMnemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xga99RVisitor visitor) {
    visitor.visitUnknownMnem(this);
  }
