...
package net.endlos.xdt99.xbas99.parser;
...
public class Xbas99Parser implements PsiParser, LightPsiParser {
  ...
  static boolean line(PsiBuilder b, int l) {
    ...
    p = r; // pin = 1
    r = r && line_1(b, l + 1);
    exit_section_(b, l, m, r, p, Xbas99Parser::line_recover);
    return r || p;
  }
  ...
  /* ********************************************************** */
  // LNUMBER
  public static boolean linedef(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "linedef")) return false;
    if (!nextTokenIs(b, "<line number definition>", LNUMBER)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, LINEDEF, "<line number definition>");
    r = consumeToken(b, LNUMBER);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  /* ********************************************************** */
  // NUMBER
  public static boolean lino(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "lino")) return false;
    if (!nextTokenIs(b, "<line number>", NUMBER)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, LINO, "<line number>");
  ...
  private static boolean s_print_1_0_0(PsiBuilder b, int l) {
    ...
    s_print_1_0_0_0(b, l + 1);
    return true;
  }

  // OP_HASH nexpr (OP_COMMA W_REC nexpr (OP_COMMA a_using))? OP_COLON |
  //      a_using OP_COLON
  private static boolean s_print_1_0_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "s_print_1_0_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = s_print_1_0_0_0_0(b, l + 1);
    if (!r) r = s_print_1_0_0_0_1(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // OP_HASH nexpr (OP_COMMA W_REC nexpr (OP_COMMA a_using))? OP_COLON
  private static boolean s_print_1_0_0_0_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "s_print_1_0_0_0_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, OP_HASH);
    r = r && nexpr(b, l + 1);
    r = r && s_print_1_0_0_0_0_2(b, l + 1);
    r = r && consumeToken(b, OP_COLON);
    exit_section_(b, m, null, r);
    return r;
  }
  ...
  private static boolean s_print_1_0_0_0_0_2(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "s_print_1_0_0_0_0_2")) return false;
    s_print_1_0_0_0_0_2_0(b, l + 1);
    return true;
  }

  // OP_COMMA W_REC nexpr (OP_COMMA a_using)
  private static boolean s_print_1_0_0_0_0_2_0(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "s_print_1_0_0_0_0_2_0")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeTokens(b, 0, OP_COMMA, W_REC);
    r = r && nexpr(b, l + 1);
    r = r && s_print_1_0_0_0_0_2_0_3(b, l + 1);
    exit_section_(b, m, null, r);
    return r;
  }

  // OP_COMMA a_using
  private static boolean s_print_1_0_0_0_0_2_0_3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "s_print_1_0_0_0_0_2_0_3")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, OP_COMMA);
    r = r && a_using(b, l + 1);
  ...
  // a_using OP_COLON
  private static boolean s_print_1_0_0_0_1(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "s_print_1_0_0_0_1")) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = a_using(b, l + 1);
    r = r && consumeToken(b, OP_COLON);
  ...
  // (lino | OP_HASH nexpr (OP_COMMA W_REC nexpr))?
