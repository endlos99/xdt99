...
public class Xga99RArgsDirCImpl extends ASTWrapperPsiElement implements Xga99RArgsDirC {

  public Xga99RArgsDirCImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public Xga99ROpFilename getOpFilename() {
    return findNotNullChildByClass(Xga99ROpFilename.class);
  }
