...
public class Xbas99LSubprogImpl extends ASTWrapperPsiElement implements Xbas99LSubprog {

  public Xbas99LSubprogImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitSubprog(this);
  }
