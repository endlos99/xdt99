...
public class Xga99ArgsDirTImpl extends ASTWrapperPsiElement implements Xga99ArgsDirT {

  public Xga99ArgsDirTImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<Xga99OpText> getOpTextList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, Xga99OpText.class);
  }
