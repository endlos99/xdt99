...
public class Xga99ArgsIIIImpl extends ASTWrapperPsiElement implements Xga99ArgsIII {

  public Xga99ArgsIIIImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public Xga99OpAddress getOpAddress() {
    return findNotNullChildByClass(Xga99OpAddress.class);
  }
