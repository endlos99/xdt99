...
public class Xbas99LSGoImpl extends ASTWrapperPsiElement implements Xbas99LSGo {

  public Xbas99LSGoImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitSGo(this);
  }
  ...
  public Xbas99LLabelref getLabelref() {
    return findNotNullChildByClass(Xbas99LLabelref.class);
  }
