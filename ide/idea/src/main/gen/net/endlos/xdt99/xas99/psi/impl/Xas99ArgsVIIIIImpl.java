...
public class Xas99ArgsVIIIIImpl extends ASTWrapperPsiElement implements Xas99ArgsVIIII {

  public Xas99ArgsVIIIIImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xas99Visitor visitor) {
    visitor.visitArgsVIIII(this);
  }
  ...
  public Xas99OpValue getOpValue() {
    return findNotNullChildByClass(Xas99OpValue.class);
  }
