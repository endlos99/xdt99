...
public class Xas99RArgsAdvIVImpl extends ASTWrapperPsiElement implements Xas99RArgsAdvIV {

  public Xas99RArgsAdvIVImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xas99RVisitor visitor) {
    visitor.visitArgsAdvIV(this);
  }
  ...
  public Xas99RArgsIV getArgsIV() {
    return findNotNullChildByClass(Xas99RArgsIV.class);
  }
