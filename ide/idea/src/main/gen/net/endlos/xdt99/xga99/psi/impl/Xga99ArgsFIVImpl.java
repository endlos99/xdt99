...
public class Xga99ArgsFIVImpl extends ASTWrapperPsiElement implements Xga99ArgsFIV {

  public Xga99ArgsFIVImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public Xga99OpText getOpText() {
    return findNotNullChildByClass(Xga99OpText.class);
  }
