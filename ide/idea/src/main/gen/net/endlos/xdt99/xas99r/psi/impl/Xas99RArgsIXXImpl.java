...
public class Xas99RArgsIXXImpl extends ASTWrapperPsiElement implements Xas99RArgsIXX {

  public Xas99RArgsIXXImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xas99RVisitor visitor) {
    visitor.visitArgsIXX(this);
  }
