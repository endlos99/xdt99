...
public class Xas99ROpFloatImpl extends ASTWrapperPsiElement implements Xas99ROpFloat {

  public Xas99ROpFloatImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xas99RVisitor visitor) {
    visitor.visitOpFloat(this);
  }
