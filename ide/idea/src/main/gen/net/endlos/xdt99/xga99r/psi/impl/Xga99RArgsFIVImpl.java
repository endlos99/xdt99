...
public class Xga99RArgsFIVImpl extends ASTWrapperPsiElement implements Xga99RArgsFIV {

  public Xga99RArgsFIVImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xga99RVisitor visitor) {
    visitor.visitArgsFIV(this);
  }
  ...
  @Override
  @NotNull
  public Xga99ROpText getOpText() {
    return findNotNullChildByClass(Xga99ROpText.class);
  }
