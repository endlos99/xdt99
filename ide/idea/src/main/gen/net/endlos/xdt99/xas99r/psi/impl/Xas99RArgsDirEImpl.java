...
public class Xas99RArgsDirEImpl extends ASTWrapperPsiElement implements Xas99RArgsDirE {

  public Xas99RArgsDirEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xas99RVisitor visitor) {
    visitor.visitArgsDirE(this);
  }
  ...
  @Override
  @NotNull
  public Xas99RExpr getExpr() {
    return findNotNullChildByClass(Xas99RExpr.class);
  }
