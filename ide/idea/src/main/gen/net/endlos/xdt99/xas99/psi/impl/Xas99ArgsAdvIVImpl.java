...
public class Xas99ArgsAdvIVImpl extends ASTWrapperPsiElement implements Xas99ArgsAdvIV {

  public Xas99ArgsAdvIVImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Xas99ArgsIV getArgsIV() {
    return findNotNullChildByClass(Xas99ArgsIV.class);
  }
