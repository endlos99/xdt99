...
public class Xbas99AThenElseImpl extends ASTWrapperPsiElement implements Xbas99AThenElse {

  public Xbas99AThenElseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public Xbas99Slist getSlist() {
    return findChildByClass(Xbas99Slist.class);
  }
