...
public class Xas99RArgsAdvVIIIImpl extends ASTWrapperPsiElement implements Xas99RArgsAdvVIII {

  public Xas99RArgsAdvVIIIImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Xas99RArgsVIII getArgsVIII() {
    return findNotNullChildByClass(Xas99RArgsVIII.class);
  }
