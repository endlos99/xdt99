...
public class Xbas99SIfImpl extends ASTWrapperPsiElement implements Xbas99SIf {

  public Xbas99SIfImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<Xbas99AThenElse> getAThenElseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, Xbas99AThenElse.class);
  }
