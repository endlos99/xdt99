...
public class Xga99RArgsFXImpl extends ASTWrapperPsiElement implements Xga99RArgsFX {

  public Xga99RArgsFXImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Xga99ROpAddress getOpAddress() {
    return findChildByClass(Xga99ROpAddress.class);
  }
