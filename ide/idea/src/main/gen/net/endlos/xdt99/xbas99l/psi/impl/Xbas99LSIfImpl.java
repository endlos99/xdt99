...
public class Xbas99LSIfImpl extends ASTWrapperPsiElement implements Xbas99LSIf {

  public Xbas99LSIfImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitSIf(this);
  }
  ...
  @Override
  @NotNull
  public List<Xbas99LAThenElse> getAThenElseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, Xbas99LAThenElse.class);
  }
