...
public class Xbas99LSForImpl extends ASTWrapperPsiElement implements Xbas99LSFor {

  public Xbas99LSForImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Xbas99LNvarW getNvarW() {
    return findNotNullChildByClass(Xbas99LNvarW.class);
  }
