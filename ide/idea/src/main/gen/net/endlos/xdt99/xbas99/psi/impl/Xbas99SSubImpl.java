...
public class Xbas99SSubImpl extends ASTWrapperPsiElement implements Xbas99SSub {

  public Xbas99SSubImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<Xbas99Param> getParamList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, Xbas99Param.class);
  }
