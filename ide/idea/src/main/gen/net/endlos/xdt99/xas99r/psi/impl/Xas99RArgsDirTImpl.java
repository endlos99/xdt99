...
public class Xas99RArgsDirTImpl extends ASTWrapperPsiElement implements Xas99RArgsDirT {

  public Xas99RArgsDirTImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<Xas99ROpText> getOpTextList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, Xas99ROpText.class);
  }
