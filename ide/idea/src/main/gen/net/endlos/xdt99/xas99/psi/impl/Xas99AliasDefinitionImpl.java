...
public class Xas99AliasDefinitionImpl extends ASTWrapperPsiElement implements Xas99AliasDefinition {

  public Xas99AliasDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
