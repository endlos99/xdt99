...
public class Xbas99LSDeleteImpl extends ASTWrapperPsiElement implements Xbas99LSDelete {

  public Xbas99LSDeleteImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Xbas99LSexpr getSexpr() {
    return findNotNullChildByClass(Xbas99LSexpr.class);
  }
