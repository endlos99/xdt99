...
public class Xga99ArgsDirFImpl extends ASTWrapperPsiElement implements Xga99ArgsDirF {

  public Xga99ArgsDirFImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public Xga99OpFloat getOpFloat() {
    return findNotNullChildByClass(Xga99OpFloat.class);
  }
