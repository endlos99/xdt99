...
public class Xbas99SGoImpl extends ASTWrapperPsiElement implements Xbas99SGo {

  public Xbas99SGoImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Xbas99Lino getLino() {
    return findNotNullChildByClass(Xbas99Lino.class);
  }
