...
public class Xas99RArgsDirFImpl extends ASTWrapperPsiElement implements Xas99RArgsDirF {

  public Xas99RArgsDirFImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public Xas99ROpFloat getOpFloat() {
    return findNotNullChildByClass(Xas99ROpFloat.class);
  }
