...
public class Xga99RArgsVIIImpl extends ASTWrapperPsiElement implements Xga99RArgsVII {

  public Xga99RArgsVIIImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xga99RVisitor visitor) {
    visitor.visitArgsVII(this);
  }
