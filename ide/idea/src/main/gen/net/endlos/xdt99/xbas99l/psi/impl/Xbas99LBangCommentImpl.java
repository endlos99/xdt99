...
public class Xbas99LBangCommentImpl extends ASTWrapperPsiElement implements Xbas99LBangComment {

  public Xbas99LBangCommentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitBangComment(this);
  }
