...
public class Xbas99LSAcceptImpl extends ASTWrapperPsiElement implements Xbas99LSAccept {

  public Xbas99LSAcceptImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitSAccept(this);
  }
