...
public class Xbas99LSCloseImpl extends ASTWrapperPsiElement implements Xbas99LSClose {

  public Xbas99LSCloseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitSClose(this);
  }
