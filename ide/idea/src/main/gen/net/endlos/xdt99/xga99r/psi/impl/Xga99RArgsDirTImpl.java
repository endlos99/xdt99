...
public class Xga99RArgsDirTImpl extends ASTWrapperPsiElement implements Xga99RArgsDirT {

  public Xga99RArgsDirTImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<Xga99ROpText> getOpTextList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, Xga99ROpText.class);
  }
