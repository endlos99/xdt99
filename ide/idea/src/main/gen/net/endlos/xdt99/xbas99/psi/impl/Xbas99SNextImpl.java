...
public class Xbas99SNextImpl extends ASTWrapperPsiElement implements Xbas99SNext {

  public Xbas99SNextImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Xbas99NvarR getNvarR() {
    return findNotNullChildByClass(Xbas99NvarR.class);
  }
