...
public class Xas99RArgsAdvVIImpl extends ASTWrapperPsiElement implements Xas99RArgsAdvVI {

  public Xas99RArgsAdvVIImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xas99RVisitor visitor) {
    visitor.visitArgsAdvVI(this);
  }
  ...
  public Xas99RArgsVI getArgsVI() {
    return findNotNullChildByClass(Xas99RArgsVI.class);
  }
