...
public class Xbas99LSSubendImpl extends ASTWrapperPsiElement implements Xbas99LSSubend {

  public Xbas99LSSubendImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitSSubend(this);
  }
