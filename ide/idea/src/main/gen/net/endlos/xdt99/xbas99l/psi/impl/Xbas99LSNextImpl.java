...
public class Xbas99LSNextImpl extends ASTWrapperPsiElement implements Xbas99LSNext {

  public Xbas99LSNextImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitSNext(this);
  }
  ...
  public Xbas99LNvarR getNvarR() {
    return findNotNullChildByClass(Xbas99LNvarR.class);
  }
