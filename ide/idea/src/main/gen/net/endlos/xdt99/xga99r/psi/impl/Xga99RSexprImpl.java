...
public class Xga99RSexprImpl extends ASTWrapperPsiElement implements Xga99RSexpr {

  public Xga99RSexprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<Xga99RSexpr> getSexprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, Xga99RSexpr.class);
  }
