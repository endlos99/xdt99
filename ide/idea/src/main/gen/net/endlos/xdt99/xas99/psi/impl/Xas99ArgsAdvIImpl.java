...
public class Xas99ArgsAdvIImpl extends ASTWrapperPsiElement implements Xas99ArgsAdvI {

  public Xas99ArgsAdvIImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Xas99ArgsI getArgsI() {
    return findNotNullChildByClass(Xas99ArgsI.class);
  }
