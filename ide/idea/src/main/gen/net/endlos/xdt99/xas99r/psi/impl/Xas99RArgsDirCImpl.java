...
public class Xas99RArgsDirCImpl extends ASTWrapperPsiElement implements Xas99RArgsDirC {

  public Xas99RArgsDirCImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public Xas99ROpFilename getOpFilename() {
    return findNotNullChildByClass(Xas99ROpFilename.class);
  }
