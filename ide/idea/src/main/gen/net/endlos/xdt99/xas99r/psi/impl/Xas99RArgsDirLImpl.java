...
public class Xas99RArgsDirLImpl extends ASTWrapperPsiElement implements Xas99RArgsDirL {

  public Xas99RArgsDirLImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xas99RVisitor visitor) {
    visitor.visitArgsDirL(this);
  }
