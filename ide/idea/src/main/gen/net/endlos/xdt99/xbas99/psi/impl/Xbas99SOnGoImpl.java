...
public class Xbas99SOnGoImpl extends ASTWrapperPsiElement implements Xbas99SOnGo {

  public Xbas99SOnGoImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99Visitor visitor) {
    visitor.visitSOnGo(this);
  }
  ...
  @Override
  @NotNull
  public List<Xbas99Lino> getLinoList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, Xbas99Lino.class);
  }
