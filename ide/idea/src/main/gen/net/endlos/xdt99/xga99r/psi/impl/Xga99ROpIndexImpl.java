...
public class Xga99ROpIndexImpl extends ASTWrapperPsiElement implements Xga99ROpIndex {

  public Xga99ROpIndexImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xga99RVisitor visitor) {
    visitor.visitOpIndex(this);
  }
