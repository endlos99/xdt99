...
public class Xga99OpAddressImpl extends ASTWrapperPsiElement implements Xga99OpAddress {

  public Xga99OpAddressImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xga99Visitor visitor) {
    visitor.visitOpAddress(this);
  }
  ...
  @Override
  @NotNull
  public Xga99Expr getExpr() {
    return findNotNullChildByClass(Xga99Expr.class);
  }
