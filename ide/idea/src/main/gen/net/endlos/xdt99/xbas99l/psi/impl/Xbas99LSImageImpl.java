...
public class Xbas99LSImageImpl extends ASTWrapperPsiElement implements Xbas99LSImage {

  public Xbas99LSImageImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitSImage(this);
  }
