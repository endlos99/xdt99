...
public class Xas99ArgsDirSImpl extends ASTWrapperPsiElement implements Xas99ArgsDirS {

  public Xas99ArgsDirSImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public Xas99OpText getOpText() {
    return findNotNullChildByClass(Xas99OpText.class);
  }
