...
public class Xga99RArgsVIImpl extends ASTWrapperPsiElement implements Xga99RArgsVI {

  public Xga99RArgsVIImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Xga99ROpGd getOpGd() {
    return findNotNullChildByClass(Xga99ROpGd.class);
  }
