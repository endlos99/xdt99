...
public class Xbas99LSRestoreImpl extends ASTWrapperPsiElement implements Xbas99LSRestore {

  public Xbas99LSRestoreImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitSRestore(this);
  }
