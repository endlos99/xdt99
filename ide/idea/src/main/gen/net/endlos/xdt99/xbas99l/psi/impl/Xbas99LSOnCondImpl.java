...
public class Xbas99LSOnCondImpl extends ASTWrapperPsiElement implements Xbas99LSOnCond {

  public Xbas99LSOnCondImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99LVisitor visitor) {
    visitor.visitSOnCond(this);
  }
