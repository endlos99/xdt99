...
public class Xas99RArgsDirSImpl extends ASTWrapperPsiElement implements Xas99RArgsDirS {

  public Xas99RArgsDirSImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xas99RVisitor visitor) {
    visitor.visitArgsDirS(this);
  }
  ...
  @Override
  @NotNull
  public Xas99ROpText getOpText() {
    return findNotNullChildByClass(Xas99ROpText.class);
  }
