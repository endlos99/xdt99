...
public class Xas99ArgsDirFImpl extends ASTWrapperPsiElement implements Xas99ArgsDirF {

  public Xas99ArgsDirFImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public Xas99OpFloat getOpFloat() {
    return findNotNullChildByClass(Xas99OpFloat.class);
  }
