...
public class Xas99ROpRegisterImpl extends ASTWrapperPsiElement implements Xas99ROpRegister {

  public Xas99ROpRegisterImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public Xas99ROpAlias getOpAlias() {
    return findChildByClass(Xas99ROpAlias.class);
  }
