...
public class Xga99ArgsDirCImpl extends ASTWrapperPsiElement implements Xga99ArgsDirC {

  public Xga99ArgsDirCImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public Xga99OpFilename getOpFilename() {
    return findNotNullChildByClass(Xga99OpFilename.class);
  }
