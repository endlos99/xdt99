...
public class Xas99RArgsAdvIImpl extends ASTWrapperPsiElement implements Xas99RArgsAdvI {

  public Xas99RArgsAdvIImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xas99RVisitor visitor) {
    visitor.visitArgsAdvI(this);
  }
  ...
  public Xas99RArgsI getArgsI() {
    return findNotNullChildByClass(Xas99RArgsI.class);
  }
