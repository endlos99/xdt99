...
public class Xga99RArgsIIIImpl extends ASTWrapperPsiElement implements Xga99RArgsIII {

  public Xga99RArgsIIIImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public Xga99ROpAddress getOpAddress() {
    return findNotNullChildByClass(Xga99ROpAddress.class);
  }
