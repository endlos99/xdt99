...
public class Xas99RArgsDirEOImpl extends ASTWrapperPsiElement implements Xas99RArgsDirEO {

  public Xas99RArgsDirEOImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Xas99RExpr getExpr() {
    return findChildByClass(Xas99RExpr.class);
  }
