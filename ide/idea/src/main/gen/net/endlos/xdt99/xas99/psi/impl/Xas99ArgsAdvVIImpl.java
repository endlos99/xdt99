...
public class Xas99ArgsAdvVIImpl extends ASTWrapperPsiElement implements Xas99ArgsAdvVI {

  public Xas99ArgsAdvVIImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Xas99ArgsVI getArgsVI() {
    return findNotNullChildByClass(Xas99ArgsVI.class);
  }
