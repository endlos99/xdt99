...
public class Xas99RArgsDirEVImpl extends ASTWrapperPsiElement implements Xas99RArgsDirEV {

  public Xas99RArgsDirEVImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xas99RVisitor visitor) {
    visitor.visitArgsDirEV(this);
  }
