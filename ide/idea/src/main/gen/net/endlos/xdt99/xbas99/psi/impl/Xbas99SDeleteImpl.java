...
public class Xbas99SDeleteImpl extends ASTWrapperPsiElement implements Xbas99SDelete {

  public Xbas99SDeleteImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xbas99Visitor visitor) {
    visitor.visitSDelete(this);
  }
  ...
  @Override
  @NotNull
  public Xbas99Sexpr getSexpr() {
    return findNotNullChildByClass(Xbas99Sexpr.class);
  }
