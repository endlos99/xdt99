...
public class Xga99RArgsFIXImpl extends ASTWrapperPsiElement implements Xga99RArgsFIX {

  public Xga99RArgsFIXImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Xga99RVisitor visitor) {
    visitor.visitArgsFIX(this);
  }
  ...
  @Override
  @Nullable
  public Xga99ROpGs getOpGs() {
    return findChildByClass(Xga99ROpGs.class);
  }

  @Override
  @NotNull
  public Xga99ROpValue getOpValue() {
    return findNotNullChildByClass(Xga99ROpValue.class);
  }
