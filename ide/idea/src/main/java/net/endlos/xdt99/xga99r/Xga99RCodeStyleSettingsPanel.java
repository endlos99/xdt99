...
public class Xga99RCodeStyleSettingsPanel extends CodeStyleAbstractPanel {
    ...
    public Xga99RCodeStyleSettingsPanel(CodeStyleSettings settings) {
        super(settings);
        createUIComponents();
    }

    public void apply(CodeStyleSettings settings) {
        Xga99RCodeStyleSettings xgaSettings = settings.getCustomSettings(Xga99RCodeStyleSettings.class);
