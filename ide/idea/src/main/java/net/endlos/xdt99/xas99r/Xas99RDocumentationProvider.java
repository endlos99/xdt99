...
public class Xas99RDocumentationProvider extends AbstractDocumentationProvider {
    ...
    public @Nullable String generateDoc(PsiElement element, @Nullable PsiElement originalElement) {
        if (element instanceof Xas99RLabeldef) {  // for some reason, we get Labeldef instead of OpLabel
            ...
            final String def = Xas99RUtil.getLabeldefText((Xas99RLabeldef) element, lino);  // modified lino
            if (def == null)
                return null;
