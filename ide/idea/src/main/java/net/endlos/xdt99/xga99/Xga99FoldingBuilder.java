...
import net.endlos.xdt99.xga99.psi.Xga99Linecomment;
...
public class Xga99FoldingBuilder extends FoldingBuilderEx {
    private static final String folderName = "Xga99Folder";
    ...
    private PsiElement getNextComment(PsiElement element) {
        while (element != null && !(element instanceof Xga99Linecomment)) {
    ...
    private PsiElement getNextNonComment(PsiElement element) {
        while (element instanceof Xga99Linecomment) {
