...
public class Xga99RQuoteHandler implements QuoteHandler {
    private static final TokenSet quoteTokens = TokenSet.create(Xga99RTypes.OP_QUOTE, Xga99RTypes.OP_FQUOTE);
    ...
    public boolean isClosingQuote(HighlighterIterator iterator, int offset) {
        ...
        char quote = token == Xga99RTypes.OP_QUOTE ? '\'' : '"';
