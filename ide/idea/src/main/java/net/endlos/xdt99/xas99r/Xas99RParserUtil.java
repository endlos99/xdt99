...
import static net.endlos.xdt99.xas99r.parser.Xas99RParser.opLabel;
import static net.endlos.xdt99.xas99r.parser.Xas99RParser.opRegister;


public class Xas99RParserUtil extends GeneratedParserUtilBase {
    ...
    public static boolean registerAlias(PsiBuilder builder, int level) {
        ...
        // - label : REQU
        // - label : \n REQU
        if (builder.lookAhead(1) == Xas99RTypes.DIR_RA ||
                (builder.lookAhead(1) == Xas99RTypes.OP_COLON &&
                        (builder.lookAhead(2) == Xas99RTypes.DIR_RA ||
                                builder.lookAhead(3) == Xas99RTypes.DIR_RA))) {
