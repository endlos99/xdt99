...
public class Xas99RCodeStyleSettingsPanel extends CodeStyleAbstractPanel {
    ...
    public Xas99RCodeStyleSettingsPanel(CodeStyleSettings settings) {
        super(settings);
        createUIComponents();
    }

    public void apply(CodeStyleSettings settings) {
        Xas99RCodeStyleSettings xasSettings = settings.getCustomSettings(Xas99RCodeStyleSettings.class);
