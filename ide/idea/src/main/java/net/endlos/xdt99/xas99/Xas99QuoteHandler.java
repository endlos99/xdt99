...
public class Xas99QuoteHandler implements QuoteHandler {
    private static final TokenSet quoteTokens = TokenSet.create(Xas99Types.OP_QUOTE, Xas99Types.OP_FQUOTE);
    ...
    public boolean isClosingQuote(HighlighterIterator iterator, int offset) {
        ...
        char quote = token == Xas99Types.OP_QUOTE ? '\'' : '"';
