...
public class Xga99QuoteHandler implements QuoteHandler {
    private static final TokenSet quoteTokens = TokenSet.create(Xga99Types.OP_QUOTE, Xga99Types.OP_FQUOTE);
    ...
    public boolean isClosingQuote(HighlighterIterator iterator, int offset) {
        ...
        char quote = token == Xga99Types.OP_QUOTE ? '\'' : '"';
