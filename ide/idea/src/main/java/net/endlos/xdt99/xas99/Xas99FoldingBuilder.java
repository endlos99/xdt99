...
public class Xas99FoldingBuilder extends FoldingBuilderEx implements DumbAware {
    private static final String folderName = "Xas99Folder";
    ...
    private PsiElement getNextNonComment(PsiElement element) {
        while (element instanceof Xas99Linecomment) {
