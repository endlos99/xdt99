...
public class Xas99EditorWriteActionHandler13 extends EditorWriteActionHandler {
    private final EditorActionHandler defaultHandler;
    private final String maxTabs = "                                                            ";  // 60 spaces

    public Xas99EditorWriteActionHandler13(EditorActionHandler defaultHandler) {
        this.defaultHandler = defaultHandler;
    }

    public Xas99EditorWriteActionHandler13(EditorActionHandler defaultHandler, boolean runForEachCaret) {
