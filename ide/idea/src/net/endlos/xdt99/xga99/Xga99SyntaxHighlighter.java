...
public class Xga99SyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public static final TokenSet directives = TokenSet.create(Xga99Types.DIR_S, Xga99Types.DIR_M);
...
public static final TextAttributesKey INSTRUCTION = createTextAttributesKey("XDT99_INSTR", DefaultLanguageHighlighterColors.KEYWORD);
    public static final TextAttributesKey FINSTRUCTION = createTextAttributesKey("XDT99_FINSTR", DefaultLanguageHighlighterColors.KEYWORD);
    public static final TextAttributesKey DIRECTIVE = createTextAttributesKey("XDT99_DIR", DefaultLanguageHighlighterColors.INSTANCE_FIELD);
    public static final TextAttributesKey PREPROCESSOR = createTextAttributesKey("XDT99_PREP", DefaultLanguageHighlighterColors.METADATA);
    public static final TextAttributesKey VALUE = createTextAttributesKey("XDT99_VALUE", DefaultLanguageHighlighterColors.NUMBER);
    public static final TextAttributesKey TEXT = createTextAttributesKey("XDT99_TEXT", DefaultLanguageHighlighterColors.STRING);
    ...
    public static final TextAttributesKey SEPARATOR = createTextAttributesKey("XDT99_SEP", DefaultLanguageHighlighterColors.COMMA);
    ...
    public static final TextAttributesKey LCOMMENT = createTextAttributesKey("XDT99_LCOMMENT", DefaultLanguageHighlighterColors.DOC_COMMENT);
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
        if (instructions.contains(tokenType)) {
            ...
            return VALUE_KEYS;
        } else if (tokenType.equals(Xga99Types.TEXT)) {
            return TEXT_KEYS;
